                                        ...
                                        <div class="product_panel panel active">
                                            <div class="arrivals_slider slider">
                                                ...
                                                <div class="arrivals_slider_item">
                                                    <div class="border_active"></div>
                                                    <div class="product_item is_new d-flex flex-column align-items-center justify-content-center text-center">
                                                        <div class="product_image d-flex flex-column align-items-center justify-content-center"><img src="<c:url value="/resources/images/new_1.jpg" />" alt=""></div>
                                                        <div class="product_content">
                                                            <div class="product_price">$225</div>
                                                ...
                                                <div class="arrivals_slider_item">
                                                    <div class="border_active"></div>
                                                    <div class="product_item is_new d-flex flex-column align-items-center justify-content-center text-center">
                                                        <div class="product_image d-flex flex-column align-items-center justify-content-center"><img src="<c:url value="/resources/images/new_2.jpg" />" alt=""></div>
                                                        <div class="product_content">
                                                            <div class="product_price">$379</div>
                                                ...
                                                <div class="arrivals_slider_item">
                                                    <div class="border_active"></div>
                                                    <div class="product_item is_new d-flex flex-column align-items-center justify-content-center text-center">
                                                        <div class="product_image d-flex flex-column align-items-center justify-content-center"><img src="<c:url value="/resources/images/new_3.jpg" />" alt=""></div>
                                                        <div class="product_content">
                                                            <div class="product_price">$379</div>
                                                ...
                                                <div class="arrivals_slider_item">
                                                    <div class="border_active"></div>
                                                    <div class="product_item is_new d-flex flex-column align-items-center justify-content-center text-center">
                                                        <div class="product_image d-flex flex-column align-items-center justify-content-center"><img src="<c:url value="/resources/images/new_4.jpg" />" alt=""></div>
                                                        <div class="product_content">
                                                            <div class="product_price">$225</div>
                                                ...
                                                <div class="arrivals_slider_item">
                                                    <div class="border_active"></div>
                                                    <div class="product_item is_new d-flex flex-column align-items-center justify-content-center text-center">
                                                        <div class="product_image d-flex flex-column align-items-center justify-content-center"><img src="<c:url value="/resources/images/new_5.jpg" />" alt=""></div>
                                                        <div class="product_content">
                                                            <div class="product_price">$225</div>
                                                ...
                                                <div class="arrivals_slider_item">
                                                    <div class="border_active"></div>
                                                    <div class="product_item is_new d-flex flex-column align-items-center justify-content-center text-center">
                                                        <div class="product_image d-flex flex-column align-items-center justify-content-center"><img src="<c:url value="/resources/images/new_6.jpg" />" alt=""></div>
                                                        <div class="product_content">
                                                            <div class="product_price">$379</div>
                                                ...
                                                <div class="arrivals_slider_item">
                                                    <div class="border_active"></div>
                                                    <div class="product_item is_new d-flex flex-column align-items-center justify-content-center text-center">
                                                        <div class="product_image d-flex flex-column align-items-center justify-content-center"><img src="<c:url value="/resources/images/new_7.jpg" />" alt=""></div>
                                                        <div class="product_content">
                                                            <div class="product_price">$379</div>
                                                ...
                                                <div class="arrivals_slider_item">
                                                    <div class="border_active"></div>
                                                    <div class="product_item is_new d-flex flex-column align-items-center justify-content-center text-center">
                                                        <div class="product_image d-flex flex-column align-items-center justify-content-center"><img src="<c:url value="/resources/images/new_8.jpg" />" alt=""></div>
                                                        <div class="product_content">
                                                            <div class="product_price">$225</div>
                                    ...
                                    <div class="col-lg-3">
                                        <div class="arrivals_single clearfix">
                                            <div class="d-flex flex-column align-items-center justify-content-center">
                                                <div class="arrivals_single_image"><img src="<c:url value="/resources/images/new_single.png" />" alt=""></div>
                                    ...
                                    <div class="bestsellers_slider slider">
                                        ...
                                        <div class="bestsellers_item discount">
                                            <div class="bestsellers_item_container d-flex flex-row align-items-center justify-content-start">
                                                <div class="bestsellers_image"><img src="<c:url value="/resources/images/best_1.png" />" alt=""></div>
                                        ...
                                        <div class="bestsellers_item discount">
                                            <div class="bestsellers_item_container d-flex flex-row align-items-center justify-content-start">
                                                <div class="bestsellers_image"><img src="<c:url value="/resources/images/best_2.png" />" alt=""></div>
                                                <div class="bestsellers_content">
                                                    <div class="bestsellers_category"><a href="#">Headphones</a></div>
                                        ...
                                        <div class="bestsellers_item">
                                            <div class="bestsellers_item_container d-flex flex-row align-items-center justify-content-start">
                                                <div class="bestsellers_image"><img src="<c:url value="/resources/images/best_3.png" />" alt=""></div>
                                                <div class="bestsellers_content">
                                                    <div class="bestsellers_category"><a href="#">Headphones</a></div>
                                        ...
                                        <div class="bestsellers_item">
                                            <div class="bestsellers_item_container d-flex flex-row align-items-center justify-content-start">
                                                <div class="bestsellers_image"><img src="<c:url value="/resources/images/best_4.png" />" alt=""></div>
                                                <div class="bestsellers_content">
                                                    <div class="bestsellers_category"><a href="#">Headphones</a></div>
                                        ...
                                        <div class="bestsellers_item discount">
                                            <div class="bestsellers_item_container d-flex flex-row align-items-center justify-content-start">
                                                <div class="bestsellers_image"><img src="<c:url value="/resources/images/best_5.png" />" alt=""></div>
                                                <div class="bestsellers_content">
                                                    <div class="bestsellers_category"><a href="#">Headphones</a></div>
                                        ...
                                        <div class="bestsellers_item">
                                            <div class="bestsellers_item_container d-flex flex-row align-items-center justify-content-start">
                                                <div class="bestsellers_image"><img src="<c:url value="/resources/images/best_6.png" />" alt=""></div>
                                                <div class="bestsellers_content">
                                                    <div class="bestsellers_category"><a href="#">Headphones</a></div>
                                ...
                                <div class="owl-carousel owl-theme reviews_slider">
                                    ...
                                    <div class="owl-item">
                                        <div class="review d-flex flex-row align-items-start justify-content-start">
                                            <div><div class="review_image"><img src="<c:url value="/resources/images/review_1.jpg" />" alt=""></div></div>
                                    ...
                                    <div class="owl-item">
                                        <div class="review d-flex flex-row align-items-start justify-content-start">
                                            <div><div class="review_image"><img src="<c:url value="/resources/images/review_2.jpg" />" alt=""></div></div>
                                            <div class="review_content">
                                    ...
                                    <div class="owl-item">
                                        <div class="review d-flex flex-row align-items-start justify-content-start">
                                            <div><div class="review_image"><img src="<c:url value="/resources/images/review_3.jpg" />" alt=""></div></div>
                                            <div class="review_content">
                                ...
                                <div class="owl-carousel owl-theme viewed_slider">
                                    ...
                                    <div class="owl-item">
                                        <div class="viewed_item discount d-flex flex-column align-items-center justify-content-center text-center">
                                            <div class="viewed_image"><img src="<c:url value="/resources/images/view_1.jpg" />" alt=""></div>
                                    ...
                                    <div class="owl-item">
                                        <div class="viewed_item d-flex flex-column align-items-center justify-content-center text-center">
                                            <div class="viewed_image"><img src="<c:url value="/resources/images/view_2.jpg" />" alt=""></div>
                                            <div class="viewed_content text-center">
                                    ...
                                    <div class="owl-item">
                                        <div class="viewed_item d-flex flex-column align-items-center justify-content-center text-center">
                                            <div class="viewed_image"><img src="<c:url value="/resources/images/view_3.jpg" />" alt=""></div>
                                            <div class="viewed_content text-center">
                                    ...
                                    <div class="owl-item">
                                        <div class="viewed_item is_new d-flex flex-column align-items-center justify-content-center text-center">
                                            <div class="viewed_image"><img src="<c:url value="/resources/images/view_4.jpg" />" alt=""></div>
                                            <div class="viewed_content text-center">
                                                <div class="viewed_price">$379</div>
                                    ...
                                    <div class="owl-item">
                                        <div class="viewed_item discount d-flex flex-column align-items-center justify-content-center text-center">
                                            <div class="viewed_image"><img src="<c:url value="/resources/images/view_5.jpg" />" alt=""></div>
                                            <div class="viewed_content text-center">
                                                <div class="viewed_price">$225<span>$300</span></div>
                                    ...
                                    <div class="owl-item">
                                        <div class="viewed_item d-flex flex-column align-items-center justify-content-center text-center">
                                            <div class="viewed_image"><img src="<c:url value="/resources/images/view_6.jpg" />" alt=""></div>
                                            <div class="viewed_content text-center">
                        ...
                        <div class="col">
                            <div class="brands_slider_container">
                                ...
                                <div class="owl-carousel owl-theme brands_slider">
                                    ...
                                    <div class="owl-item"><div class="brands_item d-flex flex-column justify-content-center"><img src="<c:url value="/resources/images/brands_1.jpg" />" alt=""></div></div>
                                    <div class="owl-item"><div class="brands_item d-flex flex-column justify-content-center"><img src="<c:url value="/resources/images/brands_2.jpg" />" alt=""></div></div>
                                    <div class="owl-item"><div class="brands_item d-flex flex-column justify-content-center"><img src="<c:url value="/resources/images/brands_3.jpg" />" alt=""></div></div>
                                    <div class="owl-item"><div class="brands_item d-flex flex-column justify-content-center"><img src="<c:url value="/resources/images/brands_4.jpg" />" alt=""></div></div>
                                    <div class="owl-item"><div class="brands_item d-flex flex-column justify-content-center"><img src="<c:url value="/resources/images/brands_5.jpg" />" alt=""></div></div>
                                    <div class="owl-item"><div class="brands_item d-flex flex-column justify-content-center"><img src="<c:url value="/resources/images/brands_6.jpg" />" alt=""></div></div>
                                    <div class="owl-item"><div class="brands_item d-flex flex-column justify-content-center"><img src="<c:url value="/resources/images/brands_7.jpg" />" alt=""></div></div>
                                    <div class="owl-item"><div class="brands_item d-flex flex-column justify-content-center"><img src="<c:url value="/resources/images/brands_8.jpg" />" alt=""></div></div>
                                </div>
