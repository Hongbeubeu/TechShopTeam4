				...
				<div class="col">
					<div class="newsletter_container d-flex flex-lg-row flex-column align-items-lg-center align-items-center justify-content-lg-start justify-content-center">
						<div class="newsletter_title_container">
							<div class="newsletter_icon"><img src="<c:url value="/resources/images/send.png" />" alt=""></div>
...
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
						...
						<div class="logos ml-sm-auto">
							<ul class="logos_list">
								<li><a href="#"><img src="<c:url value="/resources/images/logos_1.png" />" alt=""></a></li>
								<li><a href="#"><img src="<c:url value="/resources/images/logos_2.png" />" alt=""></a></li>
								<li><a href="#"><img src="<c:url value="/resources/images/logos_3.png" />" alt=""></a></li>
								<li><a href="#"><img src="<c:url value="/resources/images/logos_4.png" />" alt=""></a></li>
							</ul>
						</div>
					</div>
				</div>
